...
class TestUser2(unittest.TestCase):  
        def setUp(self):
            self.user1 = User2(name="name", passWord="name", nombre="cristian", apellido="candia", telefono="123-321", ci = "123321", email= "@email.com")
            self.contador = 0
      
        def testGuardar(self):  
            resp = self.user1.add_usr()
            print "Creamos un usuario nuevo" + self.user1.__repr__
